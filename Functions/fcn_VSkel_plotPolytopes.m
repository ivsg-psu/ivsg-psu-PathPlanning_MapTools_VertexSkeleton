function [fig] = fcn_VSkel_plotPolytopes(polytopes,fig_num,line_spec,line_width,varargin)
...
%      fig1 = fcn_VSkel_plotPolytopes(polytopes,[],'-',2,[0.5 0 0]);
%      fig2 = fcn_VSkel_plotPolytopes(polytopes,998,'-',2,[0 0 0.5],[0 mapx 0 mapy]);
%      fig3 = fcn_VSkel_plotPolytopes(polytopes,999,'-',2,[0 0.5 0],[0 mapx 0 mapy],'square');
%      fig4 = fcn_VSkel_plotPolytopes(polytopes,1000,'-',2,[0 0 0],[0 mapx 0 mapy],'square',[1 0 0 0 0.5]);
...
%      fcn_VSkel_plotPolytopes(polytopes2,fig2,'b--',2,[0 mapx 0 mapy])
%      fcn_VSkel_plotPolytopes(polytopes2,fig3,'g-',3,[0 mapx 0 mapy],'square')
%      fcn_VSkel_plotPolytopes(polytopes2,fig4,'k-',3,[0 mapx 0 mapy],'square',[1 0 0 0 0.5])
%
% For more examples, see: script_test_fcn_VSkel_plotPolytopes.m
%
...
function [map_polytopes,all_pts,mu_rad_final,sigma_rad_final] = ...
    fcn_VSkel_polytopeVSkel(...
    low_pt,high_pt,...
    xlow,xhigh,ylow,yhigh,...
    des_radius,sigma_radius,min_rad,shrink_seed)
% fcn_VSkel_polytopeVSkel creates a polytope map generated by a Halton
...
% EXAMPLES:
%
% See the script: script_test_fcn_VSkel_polytopeVSkel
...
tiled_polytopes = fcn_VSkel_haltonVoronoiTiling(low_pt,high_pt);
...
[map_polytopes,mu_rad_final,sigma_rad_final] = fcn_VSkel_polytopeShrinkToRadius(trim_polytopes,des_radius,sigma_radius,min_rad);
