...
% DEPENDENCIES:
%
%     fcn_VSkel_polytopeCentroidAndArea
%     fcn_DebugTools_checkInputsToFunctions
%
%
% EXAMPLES:
%
% See the script: script_test_fcn_VSkel_fillPolytopeFieldsFromVertices
...
for ith_poly = 1:num_poly
    ...
    [angles, ~, ~] = fcn_VSkel_polytopeFindVertexAngles(...
    ...
    [filled_polytopes(ith_poly).mean,filled_polytopes(ith_poly).area] = ...
        fcn_VSkel_polytopeCentroidAndArea(polytopes(ith_poly).vertices);
...
if flag_do_plot
    ...
    % plot the polytopes
    fcn_VSkel_plotPolytopes(filled_polytopes,fig_num,'b',2);
