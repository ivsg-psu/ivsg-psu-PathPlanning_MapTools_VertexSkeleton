% script_test_fcn_VSkel_plotVertexSkeleton
% Tests function: fcn_VSkel_plotVertexSkeleton
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fcn_VSkel_plotVertexSkeleton(vertices, projection_vectors, cut_distance, (fig_num))
...
fcn_VSkel_plotVertexSkeleton(verticies, projection_vectors, cut_distance, (fig_num));
