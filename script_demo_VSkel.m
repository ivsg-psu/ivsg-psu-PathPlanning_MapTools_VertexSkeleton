...
%       script_demo_VSkel.m
% This is a script to demonstrate the functions within the VSkel code
% library. This code repo is typically located at:
%   https://github.com/ivsg-psu/ivsg-psu-PathPlanning_MapTools_VertexSkeleton
%
% If you have questions or comments, please contact Sean Brennan at
% sbrennan@psu.edu
%
% The purpose of the code is to determine the paths that verticies follow
% if the edges of polytopes defined by the verticies are shrunk inward.
...
if ~exist('flag_VSkel_Folders_Initialized','var')
    this_project_folders = {'Functions','Data'};
    fcn_INTERNAL_initializeUtilities(library_name,library_folders,library_url,this_project_folders);
    flag_VSkel_Folders_Initialized = 1;
end

%% Set environment flags for input checking in VSkel library
% These are values to set if we want to check inputs or do debugging
setenv('MATLABFLAG_VSKEL_FLAG_CHECK_INPUTS','1');
setenv('MATLABFLAG_VSKEL_FLAG_DO_DEBUG','0');
